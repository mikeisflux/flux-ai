...
import { queryHaiku } from '../services/api/flux.js';
...
const GITHUB_ISSUES_REPO_URL = "external" === 'ant' ? 'https://github.com/anthropics/claude-cli-internal/issues' : 'https://github.com/anthropics/flux-ai/issues';
type Props = {
