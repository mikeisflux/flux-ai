...
export function useUnseenDivider(messageCount: number): {
  ...
  const onScrollAway = useCallback((handle: ScrollBoxHandle) => {
    ...
    //   at max (Sarah Deaton, #flux-ai-feedback 2026-03-15)
 ...
 *
 * Fullscreen mode defaults on for ants (FLUX_AI_NO_FLICKER=0 to opt out)
 * and off for external users (FLUX_AI_NO_FLICKER=1 to opt in).
