      ...
      <Box flexDirection="column" gap={1}>
        ...
        <Box flexDirection="column" marginLeft={2}>
          <Text dimColor>
            ...
            <Link url={referrerReward ? 'https://support.claude.com/en/articles/13456702-flux-ai-guest-passes' : 'https://support.claude.com/en/articles/12875061-flux-ai-guest-passes'}>
              Terms apply.
            </Link>
          </Text>
        </Box>
