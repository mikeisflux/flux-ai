...
// event/notch — users on those can set FLUX_AI_SCROLL_SPEED=3 to match
...
/** Read FLUX_AI_SCROLL_SPEED, default 1, clamp (0, 20].
 ...
 *  set FLUX_AI_SCROLL_SPEED=3 to match vim/nvim/opencode. We can't
...
export function readScrollSpeedBase(): number {
  const raw = process.env.FLUX_AI_SCROLL_SPEED;
  if (!raw) return 1;
