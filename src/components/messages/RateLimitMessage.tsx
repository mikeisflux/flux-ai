...
import { useFluxAiLimits } from 'src/services/fluxAiLimitsHook.js';
import { shouldProcessMockLimits } from 'src/services/rateLimitMocking.js'; // Used for /mock-limits command
import { getRateLimitTier, getSubscriptionType, isFluxAISubscriber } from 'src/utils/auth.js';
...
export function RateLimitMessage(t0) {
  ...
  if ($[2] === Symbol.for("react.memo_cache_sentinel")) {
    t3 = shouldProcessMockLimits() || isFluxAISubscriber();
    $[2] = t3;
  } else {
    t3 = $[2];
  }
