...
import { isChromeExtensionInstalled, shouldEnableFluxInChrome } from '../utils/fluxInChrome/setup.js';
...
async function _temp() {
  ...
  if (!shouldEnableFluxInChrome(chromeFlag)) {
    return null;
  }
  if (true && !isFluxAISubscriber()) {
    return {
  ...
  if (chromeFlag === undefined) {
    return {
      key: "flux-in-chrome-default-enabled",
