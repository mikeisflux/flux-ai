  ...
  if ($[0] !== autoConnectIdeFlag || $[1] !== ideToInstallExtension || $[2] !== setDynamicMcpConfig || $[3] !== setIDEInstallationState || $[4] !== setShowIdeOnboarding) {
    t1 = () => {
      const addIde = function addIde(ide) {
        ...
        const autoConnectEnabled = (globalConfig.autoConnectIde || autoConnectIdeFlag || isSupportedTerminal() || process.env.FLUX_AI_SSE_PORT || ideToInstallExtension || isEnvTruthy(process.env.FLUX_AI_AUTO_CONNECT_IDE)) && !isEnvDefinedFalsy(process.env.FLUX_AI_AUTO_CONNECT_IDE);
