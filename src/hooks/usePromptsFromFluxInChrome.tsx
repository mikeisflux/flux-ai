...
import { CLAUDE_IN_CHROME_MCP_SERVER_NAME, isTrackedFluxInChromeTabId } from '../utils/fluxInChrome/common.js';
import { lazySchema } from '../utils/lazySchema.js';
import { enqueuePendingNotification } from '../utils/messageQueueManager.js';

// Schema for the prompt notification from Chrome extension (JSON-RPC 2.0 format)
const FluxInChromePromptNotificationSchema = lazySchema(() => z.object({
 ...
 */
export function usePromptsFromFluxInChrome(mcpClients, toolPermissionMode) {
  const $ = _c(6);
  useRef(undefined);
  let t0;
  if ($[0] !== mcpClients) {
