...
import { getMaxOutputTokensForModel } from '../api/flux.js'
...
export function getEffectiveContextWindowSize(model: string): number {
  ...
  const autoCompactWindow = process.env.FLUX_AI_AUTO_COMPACT_WINDOW
...
export function calculateTokenWarningState(
  ...
  const blockingLimitOverride = process.env.FLUX_AI_BLOCKING_LIMIT_OVERRIDE
