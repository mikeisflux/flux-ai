 ...
 *   FLUX_AI_OAUTH_TOKEN / FD, or keychain tokens missing metadata): Eligible —
...
export function isRemoteManagedSettingsEligible(): boolean {
  ...
  // Externally-injected tokens (CCD via FLUX_AI_OAUTH_TOKEN, CCR via
  // FLUX_AI_OAUTH_TOKEN_FILE_DESCRIPTOR, Agent SDK, CI) carry no
