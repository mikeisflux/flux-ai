...
import { shouldAutoEnableFluxInChrome } from 'src/utils/fluxInChrome/setup.js'
import { registerBatchSkill } from './batch.js'
import { registerFluxInChromeSkill } from './fluxInChrome.js'
...
export function initBundledSkills(): void {
  ...
  if (shouldAutoEnableFluxInChrome()) {
    registerFluxInChromeSkill()
  }
