...
async function handleBroadcast(
  ...
  if (!teamName) {
    throw new Error(
      'Not in a team context. Create a team with Teammate spawnTeam first, or set FLUX_AI_TEAM_NAME.',
    )
  }
  ...
  if (!senderName) {
    throw new Error(
      'Cannot broadcast: sender name is required. Set FLUX_AI_AGENT_NAME.',
    )
  }
