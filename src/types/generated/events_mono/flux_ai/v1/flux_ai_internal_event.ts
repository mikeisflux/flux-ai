...
//   protoc               unknown
// source: events_mono/flux_ai/v1/flux_ai_internal_event.proto
 ...
 * FluxAIInternalEvent.additional_metadata as JSON.
 */
...
/**
 * FluxAIInternalEvent represents events logged from Claude Code via Statsig
 ...
 */
export interface FluxAIInternalEvent {
...
function createBaseFluxAIInternalEvent(): FluxAIInternalEvent {
  return {
    event_name: '',
...
export const FluxAIInternalEvent: MessageFns<FluxAIInternalEvent> = {
  fromJSON(object: any): FluxAIInternalEvent {
    return {
  ...
  toJSON(message: FluxAIInternalEvent): unknown {
    const obj: any = {}
  ...
  create<I extends Exact<DeepPartial<FluxAIInternalEvent>, I>>(
    base?: I,
  ): FluxAIInternalEvent {
    return FluxAIInternalEvent.fromPartial(base ?? ({} as any))
  },
  fromPartial<I extends Exact<DeepPartial<FluxAIInternalEvent>, I>>(
    object: I,
  ): FluxAIInternalEvent {
    const message = createBaseFluxAIInternalEvent()
