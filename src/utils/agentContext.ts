 ...
 * variables instead: FLUX_AI_AGENT_ID, FLUX_AI_PARENT_SESSION_ID
 *
...
export type SubagentContext = {
  ...
  agentId: string
  /** The team lead's session ID (from FLUX_AI_PARENT_SESSION_ID env var), undefined for main REPL subagents */
