 ...
 * rationale. Env var: FLUX_AI_OAUTH_TOKEN_FILE_DESCRIPTOR.
...
export function getOAuthTokenFromFileDescriptor(): string | null {
  return getCredentialFromFd({
    envVar: 'FLUX_AI_OAUTH_TOKEN_FILE_DESCRIPTOR',
