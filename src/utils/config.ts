...
export type GlobalConfig = {
  ...
  fluxAIFirstTokenDate?: string // ISO timestamp of the user's first Claude Code OAuth token
  ...
  hasCompletedFluxInChromeOnboarding?: boolean // Whether Claude in Chrome onboarding has been shown
  fluxInChromeDefaultEnabled?: boolean // Whether Claude in Chrome is enabled by default (undefined means platform default)
  ...
  // Claude Code hint protocol state (<flux-ai-hint /> tags from CLIs/SDKs).
...
export const GLOBAL_CONFIG_KEYS = [
  ...
  'respectGitignore',
  'fluxInChromeDefaultEnabled',
  'hasCompletedFluxInChromeOnboarding',
