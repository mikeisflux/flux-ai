...
export const CLAUDE_IN_CHROME_MCP_SERVER_NAME = 'flux-in-chrome'
...
export function isFluxInChromeMCPServer(name: string): boolean {
...
export function trackFluxInChromeTabId(tabId: number): void {
...
export function isTrackedFluxInChromeTabId(tabId: number): boolean {
