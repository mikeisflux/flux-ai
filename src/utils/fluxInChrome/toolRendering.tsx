...
import { trackFluxInChromeTabId } from './common.js';
...
/**
 * Custom tool result message rendering for flux-in-chrome tools.
 ...
 */
export function getFluxInChromeMCPToolOverrides(toolName: string): {
