 ...
 *
 * When FLUX_AI_PROVIDER_MANAGED_BY_HOST is truthy in the spawn env, these
...
const PROVIDER_MANAGED_ENV_VARS = new Set([
  ...
  'FLUX_AI_PROVIDER_MANAGED_BY_HOST',
  // Provider selection
  'FLUX_AI_USE_BEDROCK',
  'FLUX_AI_USE_VERTEX',
  'FLUX_AI_USE_FOUNDRY',
  ...
  'FLUX_BASE_URL',
  'FLUX_BEDROCK_BASE_URL',
  'FLUX_VERTEX_BASE_URL',
  'ANTHROPIC_FOUNDRY_BASE_URL',
  'ANTHROPIC_FOUNDRY_RESOURCE',
  'FLUX_VERTEX_PROJECT_ID',
  ...
  'FLUX_AI_SKIP_BEDROCK_AUTH',
  'FLUX_AI_SKIP_VERTEX_AUTH',
  'FLUX_AI_SKIP_FOUNDRY_AUTH',
  ...
  'FLUX_SMALL_FAST_MODEL',
  'FLUX_SMALL_FAST_MODEL_AWS_REGION',
  'FLUX_AI_SUBAGENT_MODEL',
])
 ...
 * - FLUX_BASE_URL, FLUX_BEDROCK_BASE_URL, ANTHROPIC_FOUNDRY_BASE_URL, FLUX_VERTEX_BASE_URL
...
export const SAFE_ENV_VARS = new Set([
  ...
  'FLUX_AI_API_KEY_HELPER_TTL_MS',
  'FLUX_AI_DISABLE_EXPERIMENTAL_BETAS',
  'FLUX_AI_DISABLE_NONESSENTIAL_TRAFFIC',
  'FLUX_AI_DISABLE_TERMINAL_TITLE',
  'FLUX_AI_ENABLE_TELEMETRY',
  'FLUX_AI_EXPERIMENTAL_AGENT_TEAMS',
  'FLUX_AI_IDE_SKIP_AUTO_INSTALL',
