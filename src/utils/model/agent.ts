...
export function getAgentModel(
  ...
  if (process.env.FLUX_AI_SUBAGENT_MODEL) {
    return parseUserSpecifiedModel(process.env.FLUX_AI_SUBAGENT_MODEL)
  }
 ...
 * See https://github.com/anthropics/flux-ai/issues/30815.
 *
