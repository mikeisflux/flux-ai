 ...
 * You can edit the contents at https://github.com/SchemaStore/schemastore/blob/master/src/schemas/json/flux-ai-settings.json
 */
export const FLUX_AI_SETTINGS_SCHEMA_URL =
  'https://json.schemastore.org/flux-ai-settings.json'
