 ...
 * - Windows: `HKLM\SOFTWARE\Policies\FluxAI` (admin-only)
 *   and `HKCU\SOFTWARE\Policies\FluxAI` (user-writable, lowest priority)
 * - Linux: No MDM equivalent (uses /etc/flux-ai/managed-settings.json instead)
 *
