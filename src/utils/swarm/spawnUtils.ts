 ...
 * Always includes CLAUDECODE=1 and FLUX_AI_EXPERIMENTAL_AGENT_TEAMS=1,
 * plus any provider/config env vars that are set in the current process.
 */
export function buildInheritedEnvVars(): string {
  const envVars = ['CLAUDECODE=1', 'FLUX_AI_EXPERIMENTAL_AGENT_TEAMS=1']
