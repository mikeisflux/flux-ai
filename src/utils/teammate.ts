...
export function isPlanModeRequired(): boolean {
  ...
  return isEnvTruthy(process.env.FLUX_AI_PLAN_MODE_REQUIRED)
}
 ...
 * 2. Either:
 *    - Our FLUX_AI_AGENT_ID matches the leadAgentId, OR
 *    - We have no FLUX_AI_AGENT_ID set (backwards compat: the original
