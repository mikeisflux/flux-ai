 ...
 * @param teamName - Optional team name (defaults to FLUX_AI_TEAM_NAME env var or 'default')
 */
...
export type SandboxPermissionRequestMessage = {
  ...
  requestId: string
  /** Worker's FLUX_AI_AGENT_ID */
  workerId: string
  /** Worker's FLUX_AI_AGENT_NAME */
  workerName: string
  /** Worker's FLUX_AI_AGENT_COLOR */
  workerColor?: string
 ...
 * @param teamName - Optional team name (defaults to FLUX_AI_TEAM_NAME env var)
