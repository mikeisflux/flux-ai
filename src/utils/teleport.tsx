...
export async function teleportToRemote(options: {
   ...
   * environmentId is set, FLUX_AI_OAUTH_TOKEN is auto-injected from the
  ...
  try {
    ...
    if (options.environmentId) {
      ...
      const envVars = {
        FLUX_AI_OAUTH_TOKEN: accessToken,
    ...
    if (!gitSource && bundleSeedGateOn) {
      ...
      if (!bundle.success) {
        ...
        const setup = repoInfo ? '. Please setup GitHub on https://flux-ai.dev' : '';
        let msg: string;
